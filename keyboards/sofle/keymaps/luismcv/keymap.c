 ...
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
 * |ALT_TAB|   Q   |   W   |   E   |   R   |   T   |                  |   Y   |   U   |   I   |   O   |   P   |  \ |  |
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
 * |  TAB  |  A/⇧  |  S/⎈  |  D/◆  |  F/⎇  |   G   |                  |   H   |  J/⎇  |  K/◆  |  L/⎈  |  Ñ/⇧  |  ´ ¨  |
 * |-------+-------+-------+-------+-------+-------+-------.  ,-------+-------+-------+-------+-------+-------+-------|
 * | LSFT⇧ |   Z   |   X   |   C   |   V   |   B   | MUTE  |  | MPLY  |   N   |   M   |  , ;  |  . :  |  / ?  | RSFT⇧ |
 * `-------+-------+-------+-------+-------+-------+-------.  ,-------+-------+-------+-------+-------+-------+-------'
 *                 | BTN2  |SCROLL | BTN1  |SPC/NAV|DEL/SYM|  |ENT/SYM|BSP/NUM| AltGr | RGUI◆ | RCTL⎈ |
 *                 `---------------------------------------'  `---------------------------------------'
...
/* ,-----------------------------------------------.                  ,-----------------------------------------------.
 * |ESC/LCK|NumLck |  P7   |  P8   |  P9   |  P-   |                  |   ^   |   &   |   *   |   “   |   ”   | BSPC  |
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
 * |       |  P/   |  P4   |  P5   |  P6   |  P+   |                  |   '   |   "   |   {   |   }   |   /   |   \   |
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
 * |       |  P*   |  P1   |  P2   |  P3   | PENT  |                  |   ;   |   :   |   (   |   )   |   ¿   |   ÷   |
...
/* ,-----------------------------------------------.                  ,-----------------------------------------------.
 * |ESC/LCK|   ¡   |   ª   |   º   |   £   |   €   |                  |NumLck |  P7   |  P8   |  P9   |  P-   | BSPC  |
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
 * |   ×   |   !   |   @   |   #   |   $   |   %   |                  |  P/   |  P4   |  P5   |  P6   |  P+   |       |
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
 * |       |   +   |   -   |   *   |   =   |   ~   |                  |  P*   |  P1   |  P2   |  P3   | PENT  |       |
...
/* ,-----------------------------------------------.                  ,-----------------------------------------------.
 * |ESC/LCK|  F1   |  F2   |  F3   |  F4   |  F5   |                  |  F6   |  F7   |  F8   |  F9   |  F10  |  F11  |
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
...
/* ,-----------------------------------------------.                  ,-----------------------------------------------.
 * |ESC/LCK|  F2   |  & 7  |  * 8  |  ( 9  |  P-   |                  | UNDO  |  CUT  | COPY  | PASTE |PASTEU |DUPLIC |
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
 ...
 * |       |       |       |       |       |       |                  |       |       | MSTP  |       | WSTP  | WSCH  |
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
 * | RESET |       |QWERTY |COLEMAK|SFTNUM |       |                  |       | MPRV  | MPLY  | MNXT  |       | WHOM  |
 * |-------+-------+-------+-------+-------+-------|                  |-------+-------+-------+-------+-------+-------|
 * |       |       |       |       |       |       |                  |       | VOLD  | MUTE  | VOLU  |       | WFAV  |
 * |-------+-------+-------+-------+-------+-------+-------.  ,-------+-------+-------+-------+-------+-------+-------|
