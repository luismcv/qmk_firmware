...
/* ,-----------------------------------------.                ,-----------------------------------------.
 * |      |  F2  | & 7  | * 8  | ( 9  |  P-  |                | UNDO | CUT  | COPY |PASTE |PASTEU|DUPLIC|
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 ...
 *                                                                               generated by [keymapviz] */
[_NUM] = LAYOUT( \
  _______, KC_F2,   KC_7,    KC_8,  KC_9,   KC_PMNS,                      UNDO,    CUT,      COPY,     PASTE,    PASTEU,  DUPLIC,   
...
layer_state_t layer_state_set_user(layer_state_t state) { return update_tri_layer_state(state, _NAV, _NUM, _ADJUST); }
